...
7. **Creation of a per-paragraph, per-state corpus**
  ...
  - This results in 2,288 paragraph files distributed across the four state-specific subdirectories, providing a cleaned, state-organized paragraph corpus ready for lexical multi-dimensional analyses.
