...
Requires SAS output:
    sas/output_cl_st1_ph1_anna/means_group_f<n>.tsv
...
SCORES_FILE      = Path("sas/output_cl_st1_ph1_anna/cl_st1_ph1_anna_scores_only.tsv")
MEANS_PATTERN    = "sas/output_cl_st1_ph1_anna/means_group_f{dim}.tsv"
