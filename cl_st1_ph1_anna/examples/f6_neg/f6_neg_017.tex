\begin{textsample}{NEG Dim 6 – human – Score -2.00 – mg/mg\_ef\_ciencias\_da\_natureza\_intro\_p4.txt}  \label{ex:f6_neg_017}
\textbf{Observar} o mundo a sua volta e fazer perguntas.
Analisar demandas, delinear problemas e planejar investigações.
Propor hipóteses.
Planejar e realizar atividades de campo ( experimentos, observações, \textbf{leituras}, visitas, ambientes virtuais etc. ).
...
Elaborar explicações e/ou modelos. \textbf{Associar} explicações e/ou modelos à evolução histórica dos conhecimentos científicos envolvidos.
...
% matched lemmas: associar, leitura, observar
\end{textsample}
