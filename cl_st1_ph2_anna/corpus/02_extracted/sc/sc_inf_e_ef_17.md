...
Ao concluir este texto, situa-se um conjunto de recomendações/sugestões para a elaboração de diretrizes curriculares, teórico-metodológicas e operacionais para a implantação/acompanhamento da EJA no território catarinense. Assim sendo, indica-se e defende-se:
