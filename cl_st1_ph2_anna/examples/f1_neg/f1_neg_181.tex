\begin{textsample}{NEG Dim 1 – go – Score 2.00 – go/go\_ef\_28.txt}  \label{ex:f1_neg_181}
Quadro 22 - Competências Específicas de Língua Portuguesa para o Ensino Fundamental 1.
...
Fonte : BNCC 2017, pág. 85 As competências específicas do componente curricular Língua Portuguesa dialogam tanto com as competências gerais como com as competências da área de Linguagens.
A título de exemplo, pode -se observar, conforme diagrama abaixo, que a competência geral 1 dialoga com as seguintes competências específicas da área de Linguagem e do componente de Língua Portuguesa.
