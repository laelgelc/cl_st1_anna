\begin{textsample}{NEG Dim 1 – ba – Score 4.00 – ba/ba\_ef\_19.txt}  \label{ex:f1_neg_235}
8.3.1.
Organizador Curricular Em articulação com as competências gerais da Educação Básica, a área de Matemática e, por consequência, o componente curricular de Matemática devem garantir aos alunos o desenvolvimento de competências específicas.
Nesse sentido, as competências da área são as mesmas competências do componente curricular.
ÁREA DE MATEMÁTICA COMPONENTE CURRICULAR : MATEMÁTICA COMPETÊNCIAS ESPECÍFICAS DE MATEMÁTICA 1.
