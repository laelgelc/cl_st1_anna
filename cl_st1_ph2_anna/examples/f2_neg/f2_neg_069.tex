\begin{textsample}{NEG Dim 2 – mt – Score -1.00 – mt/mt\_ef\_15.txt}  \label{ex:f2_neg_069}
3.6.
Competências Específicas de Língua Portuguesa para o Ensino Fundamental VII.
...
Considerando a base teórica aqui assumida, concordamos com a assertiva de Geraldi ( 1984, p. 47 ) e finalizamos esta parte com ela : > [... ] Penso que uma proposta de ensino da língua lastreada nas possibilidades que o sistema da língua oferece, cuja exploração pelo professor depende crucialmente de seus conhecimentos sobre a língua, mas também de seu amor à língua, de sua capacidade de explorar o sistema de forma mais aberta do que seguir um roteiro de conteúdos a serem transmitidos ( sejam estes de conhecimentos descritivos da língua ou dos gêneros discursivos ), apoiando -se nas atividades epilinguísticas, estatui uma diferença entre saber uma língua, isto é, dominar as habilidades de uso da língua em situações concretas de interação, entendendo e produzindo enunciados, percebendo as diferenças entre uma forma de expressão e outra.
Outra coisa é saber analisar uma língua dominando conceitos e metalinguagens a partir dos quais se fala sobre a língua, se apresentam suas características estruturais e de uso.
