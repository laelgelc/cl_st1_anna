\begin{textsample}{NEG Dim 3 – pa – Score -4.00 – pa/pa\_em\_73.txt}  \label{ex:f3_neg_002}
Quadro 22 : Estrutura das ementas dos Campos de Saberes e Práticas Eletivos Elementos 1.
Título do campo de saberes : Este deve ser atrativo ( linguagem das \textbf{juventudes} ). 2.
...
Caso o campo eletivo seja vinculado à EPT, deve -se informar que se trata de um campo cuja itinerância integra a área e a EPT. 6. \textbf{Competência} específica de área : Referem -se às \textbf{competências} das áreas de conhecimento apresentadas na nucleação da formação geral básica.
Deve -se indicar o seu código alfanumérico.
Ex. : EM13MAT201 ( segunda \textbf{competência} da área de matemática ). 7.
Habilidades a serem trabalhadas : Refere -se às habilidades associadas às \textbf{competências} gerais da BNCC e às habilidades específicas das itinerâncias, conforme determina a Portaria MEC nº 1.432/2018.
Deve -se indicar o seu código alfanumérico.
...
Fonte : Elaboração com base nos estudos e sistematizações do ProBNCC – etapa ensino \textbf{médio} ( 2019 ).
...
Dessa forma, o DCEPA – etapa ensino \textbf{médio} apresenta em anexo um conjunto de ementas para subsidiar a elaboração de campos eletivos para serem disponibilizados nas escolas e suas respectivas ementas, que se correlacionarão com os princípios curriculares norteadores, os eixos estruturantes, as \textbf{competências} específicas de área, as habilidades específicas das itinerâncias e os objetos de conhecimento.
