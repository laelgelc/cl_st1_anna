\begin{textsample}{NEG Dim 3 – mg – Score 1.00 – mg/mg\_ef\_ciencias\_humanas\_intro\_4.txt}  \label{ex:f3_neg_025}
13.1.1 Competências Específicas de Ciências Humanas para o Ensino Fundamental 1.
...
Interpretar e expressar sentimentos, crenças e dúvidas com relação a si mesmo, aos outros e às diferentes culturas e manifestações religiosas, com base nos instrumentos de investigação das Ciências Humanas, promovendo o acolhimento e a valorização da diversidade de indivíduos e de grupos sociais, seus saberes, identidades, culturas e potencialidades, sem preconceitos de qualquer natureza. 5.
...
Utilizar as linguagens cartográficas, gráficas e iconográficas e diferentes gêneros textuais e tecnologias digitais de informação e comunicação no desenvolvimento do raciocínio espaço-temporal relacionado à localização, distância, direção, duração, simultaneidade, sucessão, ritmo e conexão.
