\begin{textsample}{NEG Dim 3 – ba – Score 1.00 – ba/ba\_ef\_25.txt}  \label{ex:f3_neg_116}
8.5.1.2.
Organizador Curricular O currículo de Geografia no Ensino Fundamental traz, na primeira coluna, as cinco unidades temáticas : O sujeito e seu lugar no mundo, Conexões e escalas, Mundo do trabalho, Formas de representação e pensamento espacial, Natureza, ambientes e qualidade de vida.
Na segunda coluna, são apresentadas as competências que tem maior articulação com os objetos de conhecimento e habilidades apresentadas na sequência.
COMPONENTE CURRICULAR : GEOGRAFIA COMPETÊNCIAS ESPECÍFICAS DE CIÊNCIAS HUMANAS 1.
...
COMPONENTE CURRICULAR : GEOGRAFIA COMPETÊNCIAS ESPECÍFICAS DE GEOGRAFIA 1.
