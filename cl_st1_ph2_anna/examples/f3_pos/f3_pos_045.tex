\begin{textsample}{POS Dim 3 – go – Score 38.00 – go/go\_inf\_19.txt}  \label{ex:f3_pos_045}
3.3.2.
...
Nesse sentido, é necessário que rompa com seus próprios estereótipos, desenvolva e/ou amplie sua capacidade expressiva, \textbf{brinque} com diferentes materiais, suportes, instrumentos musicais, \textbf{ouça} muitas e diferentes músicas, contemple obras de arte, visite diversificados espaços de cultura, assista espetáculos, leia, se permita experimentar.
...
Quais \textbf{ouvem} com maior frequência?
...
A comunidade da qual a \textbf{instituição} faz parte pode e deve ser integrada ao processo de ampliação de repertório, \textbf{convidando} as pessoas para socializarem seus talentos na \textbf{instituição}, com as \textbf{crianças} e os \textbf{adultos}.
...
Se nessa comunidade houver algum grupo de teatro ou de dança, que ele seja \textbf{convidado} a se apresentar para as \textbf{crianças} na \textbf{instituição}, oportunizando a elas a observação do processo de montagem dos diversos elementos que compõem o espetáculo : cenário, iluminação, figurino, trilha sonora, o ensaio dos movimentos e das falas.
Ou seja, que elas possam perceber todas as ações que culminam no espetáculo que é mostrado ao público.
Conduzidos assim, o teatro e a dança, nas \textbf{instituições} de Educação \textbf{Infantil}, não serão resumidos a práticas pedagógicas baseadas na reprodução de uma gestualidade sem sentido para as \textbf{crianças}, tais como os ensaios enfadonhos ; dançar tentando reproduzir a letras das músicas na coreografia ; no ensaio de passos ou ainda na memorização de textos que tenham uma apresentação como único objetivo.
...
Outro aspecto a ser pensado e \textbf{cuidado} pelos profissionais das \textbf{instituições} diz respeito ao repertório musical que é usado no trabalho com as \textbf{crianças}.
...
Também é preciso lançar \textbf{mão} de recursos tecnológicos para fazer chegar às \textbf{crianças} outras manifestações artísticas e culturais às quais não seja possível garantir o acesso direto, em especial àquelas de reconhecido valor universal, regional ou local.
...
Além disso, o trabalho desenvolvido pelas \textbf{instituições} deve se preocupar com a organização dos espaços, sua diversificação e também as formas como são usados.
Tanto se pode garantir que as \textbf{crianças} usem os espaços disponíveis na própria \textbf{instituição} : a sala, os corredores, os \textbf{pátios}, os vãos, as áreas cobertas, quanto possam extrapolar as fronteiras desta.
Que \textbf{brinquem} em \textbf{pátios}, quintais, bosques, jardins, praças, tenham acesso a outros espaços significativos, pois a convivência das \textbf{crianças} com as diferentes manifestações artísticas e culturais não pode ficar restrita ao ambiente e à convivência com as pessoas da \textbf{instituição}.
É preciso ir além do espaço circundante, garantir -lhes o acesso a outras pessoas, outras etnias, de diferentes grupos \textbf{etários}, de diferentes grupos sociais e a espaços culturais diversificados : monumentos, equipamentos públicos, museus, circos, teatros, cinemas, laboratórios, planetários, praças, jardins, \textbf{parques}, \textbf{bibliotecas} e outros lugares importantes da cidade, diversos shows e espetáculos, entre tantas outras possibilidades.
Também é preciso garantir que os \textbf{bebês} participem dos \textbf{passeios} e outras ações realizadas fora da \textbf{instituição}.
A \textbf{instituição} é uma oportunidade singular de contato com a arte, em especial na Educação \textbf{Infantil}.
Ela deve possibilitar que as \textbf{crianças} pisem o chão de mármore dos museus, que possam estar no mesmo ambiente que esculturas, quadros, instalações.
Que possam apreciar espetáculos de circo, de música, de dança e de teatro, experimentar as cadeiras estofadas, visitar \textbf{bibliotecas} e exposições, \textbf{ouvir} e cantar músicas, apreciar o silêncio, os \textbf{sons} da natureza e também de seu entorno, \textbf{manusear} \textbf{livros} e instrumentos musicais.
A \textbf{instituição} de Educação \textbf{Infantil} precisa ter, em seus diferentes espaços, as \textbf{marcas} de autoria das \textbf{crianças} que ali habitam.
...
A organização dos tempos deve ser objeto de \textbf{cuidado} constante dos professores quando do planejamento e desenvolvimento de seu trabalho na \textbf{instituição} junto às \textbf{crianças}.
...
Contudo, não se pode abrir \textbf{mão} do novo, do surpreendente, do inusitado, que podem encantar e mobilizar as \textbf{crianças} e os \textbf{adultos} envolvidos no processo.
Se a \textbf{pintura} acontece uma ou duas vezes ao ano, o contato com a tinta pode causar tamanha euforia nas \textbf{crianças} que a atividade pode se perder nesse contato.
...
Disponibilizar tintas – artesanais ou industrializadas – canetas hidrocor, \textbf{lápis} preto e de cor, instrumentos musicais, papeis, telas, carvão, giz pastel, giz para quadro, rolos, fitas adesivas, linhas, barbantes, cola, água, \textbf{areia}.
Oportunizar diferentes suportes para os rabiscos, as \textbf{marcas}, os desenhos : \textbf{paredes}, \textbf{livros}, mesas, papelão, cadeiras, o próprio corpo e os suportes digitais.
...
Por exemplo, fixar o papel que será rabiscado na mesa ou no chão, com fita adesiva, para que não deslize enquanto a \textbf{criança} faz sua produção.
...
Muitas vezes as \textbf{crianças} querem tão somente realizar experimentações em superfícies, objetos, materiais ( CUNHA, 2012 ). \textbf{Brincar}, arrastar, empurrar, sacudir, transformar e descobrir o que é possível fazer com pincel seco ou \textbf{cheio} de tinta, uma flauta, um chocalho, uma lata \textbf{cheia} de sementes, uma câmera ; com bolinhas-cravo, plástico-bolha, roupas, acessórios, fantasias, \textbf{tecidos} grandes e \textbf{pequenos}, caixas de papelão ou de \textbf{plástico}.
...
Mostrar diferentes representações de um mesmo objeto, na \textbf{instituição} ou fora dela, analisar os traçados usados pelos artistas em seus desenhos, para que as \textbf{crianças} ampliem seu repertório visual e percebam que não existe uma única forma de desenhar, por exemplo.
Fazer perguntas que ativem a memória e agucem a criatividade : - quando você \textbf{ouve} esta música se lembra de alguma coisa?
De quê? - o que você pode fazer com esta fita adesiva, já que não há outra coisa para colar com ela? - é possível pintar sem usar tintas compradas prontas? - que tipo de \textbf{som} se pode produzir usando esses objetos? - você \textbf{consegue} dançar diferente de seu \textbf{colega}? - como se pode representar o \textbf{personagem} dessa história? - o que pode ser usado para construir o cenário?
...
% matched lemmas: adulto, afeto, areia, bebê, biblioteca, brincadeira, brincar, brinquedo, cheio, colega, conseguir, contar, convidar, criança, cuidado, cuidar, diário, etário, hábito, infantil, instituição, interessar, livro, lápis, manusear, marca, mão, ouvir, parede, parque, passeio, pequeno, personagem, pintura, plástico, pátio, som, tecido
\end{textsample}
