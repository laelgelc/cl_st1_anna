\begin{textsample}{POS Dim 3 – ba – Score 30.00 – ba/ba\_inf\_10.txt}  \label{ex:f3_pos_171}
7.10.
...
Por tal razão, destacamos a necessidade de refletir sobre os campos de experiência no contexto da educação da \textbf{infância} e suas contribuições para pensar o processo de construção de conhecimentos, para construir um processo educativo que considere as trocas entre as \textbf{crianças} e entre \textbf{adultos} e \textbf{crianças}.
Em síntese, buscar contribuir para um processo educativo que tem na \textbf{criança} a sua \textbf{centralidade}.
...
No que se refere à Educação \textbf{Infantil}, dá \textbf{centralidade} à aprendizagem da \textbf{criança} e seu processo formacional, compreendidos como singularidades experienciais.
...
É com esse conjunto de dispositivos e capacidades adquiridas que as \textbf{crianças}, ao \textbf{brincar}, ao exercitar sua \textbf{curiosidade}, ao questionar, ao explorar, ao narrar, ao \textbf{escutar}, produzem descritibilidades, inteligibilidades, analisibilidades e sistematicidades, compreendidas como competências que as ajudam a questionar e criar hipóteses sobre o mundo e seus sistemas simbólicos, de uma forma sempre ativa, mesmo que nessas itinerâncias produzam erros.
...
Enquanto processo, ao mesmo tempo individual, \textbf{relacional} e simbólico, a aprendizagem, enquanto saber, saber-fazer e saber-ser, é fundamentalmente uma atividade experiencial.
...
É preciso que o educador esteja \textbf{atento} para o fato de que nem toda aprendizagem é boa.
...
Sabe -se, a fortiori, que, em realidade, quem constrói os saberes e suas formas de ação são as \textbf{crianças}, mas num mundo intensamente \textbf{relacional}.
Jogos e \textbf{brincadeiras}, como \textbf{centralidades} \textbf{lúdicas}, constroem e oportunizam descobertas e aprendizagens.
Nesses termos, é preciso \textbf{cuidar} das ambiências pedagógicas e seus dispositivos, para que essa condição e direito da \textbf{infância} seja vivido plenamente e potencialize aprendizagens formacionais.
...
O eu, o outro, o nós Na \textbf{infância}, a construção dos processos identitários, realizada por meio de inúmeras formas de observação e de indagações que envolvem as pessoas, eventos, tradições familiares, culturas em que as \textbf{crianças} estão inseridas desde os seus primeiros \textbf{dias} de vida, efetiva comparações, assim como processos de inclusão e exclusão.
...
É aqui que muitos dos seus direitos deverão ser exercidos, tendo como guardiões o Estado e a família, entre outras \textbf{instituições} educacionais, meios pelos quais também aprendem sobre seus deveres.
Da perspectiva da \textbf{infância}, esta é a condição de uma passagem evolutiva, importante, na superação gradual do seu egocentrismo, entrando em cena, com importantes aprendizagens sociais.
...
Conhecer e \textbf{cuidar} do seu corpo, assim como compreender que o corpo do outro merece \textbf{cuidado} e respeito, é parte de uma formação valorosa e valorada do ser da \textbf{criança}.
...
Na escola, esse repertório se diferencia na medida em que processos de socialização e outros são vividos a partir de aprendizagens mais ampliadas e dirigidas para competências coletivas, socialmente referenciadas. \textbf{Ouvindo} histórias e contos, confrontando pontos de vista, experimentando jogos e atividades mais formalizadas, interagindo com \textbf{adultos} e \textbf{colegas}, criando jogos com a língua, as \textbf{crianças} exploram possibilidades e produzem outras formas de comunicação prazerosa.
Num ambiente estimulante e acolhedor, o encontro com a língua escrita por meio de \textbf{livros} ilustrados, de mensagens, de orientações escritas, da convergência de mídias, a \textbf{criança} amplia o léxico e amplia, também, a aproximação com \textbf{sons}, palavras e frases corretas, e, com isso, vai experimentando o prazer da comunicação por meio da língua.
...
Na \textbf{vontade} de experimentar e questionar o mundo em que vive e as informações a que têm acesso, a atitude de pesquisa num sentido amplo já está presente no modo de ser \textbf{criança}.
...
Nesse particular, é fundamental \textbf{cuidar} das adequações cognitivas e éticas desses jogos.
...
% matched lemmas: acolher, adulto, atento, brincadeira, brincar, centralidade, colega, criança, cuidado, cuidar, curiosidade, dia, equilíbrio, escuta, escutar, gesto, infantil, infância, instituição, interessar, livro, lúdico, mímico, ouvir, pequeno, prédio, relacional, som, vontade
\end{textsample}
