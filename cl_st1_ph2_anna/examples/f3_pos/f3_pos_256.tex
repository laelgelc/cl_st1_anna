\begin{textsample}{POS Dim 3 – pi – Score 15.00 – pi/pi\_em\_11.txt}  \label{ex:f3_pos_256}
...
Por \textbf{volta} dos anos 427 a 347 a.C., a formação do homem moral, como objetivo final da educação, assim como a defesa de um estado justo para \textbf{acolher} cada indivíduo foram objetivos defendidos por Platão.
...
Neste sentido, este filósofo defendia a ideia de que a \textbf{criança} aprende com o ato de \textbf{imitar} os bons \textbf{hábitos}, e consequentemente, se tornar um cidadão ético e voltado à efetividade do bem comum em seu meio social.
...
A Igreja torna -se a detentora do conhecimento e de formas educacionais deste período, tendo em vista que somente esta \textbf{instituição} poderia dar aval, conforme seus interesses, do que poderia ser ou não lecionado.
...
No século XX, teve grande contribuição na formação da visão pedagógica, os pensamentos de Maria Montessori ( 1870-1952 ), ao defender a ideia de que a \textbf{criança} conquistava a educação, partindo da concepção de que já nascemos com a capacidade de ensinar a nós mesmos, desde que nos sejam dadas as condições.
Seus estudos basearam -se na observação de que as \textbf{crianças} aprendem melhor pela experiência direta da procura e descoberta, cabendo ao professor acompanhar o processo e detectar o modo particular de cada um manifestar seu potencial.
...
Ainda conforme Saviani ( 2006 ), as concepções tradicionais, desde a pedagogia de Platão e a pedagogia cristã, passando pelas pedagogias dos humanistas, assim como a pedagogia idealista de Kant, Fichte e Hegel, o humanismo racionalista, a teoria da evolução pautavam -se pela \textbf{centralidade} da formação intelectual.
Aqui seria possível observar que o protagonista do conhecimento era o professor, responsável por transmitir os conhecimentos acumulados pela humanidade segundo uma gradação lógica, cabendo aos alunos \textbf{assimilar} os conteúdos que lhes são transmitidos.
...
Essa adaptação ocorre através da organização, sendo que o organismo discrimina entre \textbf{estímulos} e sensações, selecionando aqueles que irá organizar em alguma forma de estrutura.
...
A aprendizagem, conforme defende Vygotsky ( 2001, p. 115 ), “ [ … ] pressupõe uma natureza social específica e um processo através do qual as \textbf{crianças} penetram na vida intelectual daqueles que a cercam ”.
...
A aprendizagem se dá por meio da interação e construção do conhecimento e também dos \textbf{laços} afetivos entre pessoas.
Wallon argumenta que as trocas \textbf{relacionais} da \textbf{criança} com os outros são fundamentais para o desenvolvimento da pessoa.
...
A constituição biológica da \textbf{criança} ao nascer não será a única do seu destino ( … ).
Os meios em que vive a \textbf{criança} e aqueles com que ela sonha constituem a forma que amolda sua pessoa ( … ) ( WALLON, 1975, p. 164 ).
Para Emília Ferreiro ( 1983 ), a construção do conhecimento tem uma lógica individual na escola e fora dela.
A aprendizagem não é provocada pela escola, mas pela própria mente das \textbf{crianças}, em que esse processo deve ser gradual dependendo de sua assimilação e de uma reacomodação dos esquemas internos, o que demanda tempo.
O processo inicial da aprendizagem é explicado também por variáveis sociais, culturais, políticas e psicolinguísticas.
Complementa a autora, que não existe ponto zero da aprendizagem escrita ; a \textbf{criança} sempre apresenta um conhecimento prévio que o sujeito reestrutura a partir de um processo de acomodação e assimilação mental.
Segundo Antoni Zabala ( 1998 ), a finalidade da escola é promover a formação integral dos alunos.
Para ele, é na \textbf{instituição} escolar, através das relações construídas a partir das experiências vividas, que se estabelecem os vínculos e as condições que definem as concepções pessoais sobre si e os demais.
...
Na visão de Libâneo ( 1994, p. 88 ), > [ … ] aprender é o processo de assimilação de qualquer forma de conhecimento, daquilo bem simples onde a \textbf{criança} aprende a \textbf{manipular} os \textbf{brinquedos}, aprende a fazer contas, lidar com as coisas, nadar, andar de bicicleta etc., até aquilo mais complexo onde uma pessoa aprende a escolher uma profissão, lidar com as outras.
...
Esse estreitamento de vínculos deve ser ponderado por regras onde todos têm liberdade, uma vez que, como afirma Freire ( 1986. p.54 ) : “ uma experiência dialógica que não se baseia na seriedade e na competência é muito pior do que uma experiência ‘ bancária ’, onde o professor simplesmente \textbf{transfere} conhecimento ”.
...
Constatar essas relações possibilita colocar “ nas \textbf{mãos} dos educadores uma arma de luta capaz de permitir -lhes o exercício de um poder real, ainda que limitado ” ( SAVIANI, 2003, p.31 ), uma vez que a educação se torna decisiva neste constante processo de transformação da realidade social.
...
% matched lemmas: acolher, assimilar, atentar, brinquedo, centralidade, criança, estímulo, hábito, imitar, instituição, laço, manipular, mão, relacional, transferir, volta
\end{textsample}
