\begin{textsample}{NEG Dim 4 – ba – Score -1.00 – ba/ba\_inf\_9.txt}  \label{ex:f4_neg_215}
7.9.
...
Nesses termos, o portfólio e o álbum de memória são dispositivos de avaliação de possibilidades valorosas para uma formação qualificada num contexto curricular da Educação Infantil.
