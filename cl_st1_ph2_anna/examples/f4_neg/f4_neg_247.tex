\begin{textsample}{NEG Dim 4 – al – Score -1.00 – al/al\_ef\_97.txt}  \label{ex:f4_neg_247}
...
Esses devem ser vistos não de forma horizontal apenas, mas na verticalidade, e no processo de ensino de forma \textbf{espiral}, em que conhecimentos se entrelacem num todo para a formação integral do estudante.
