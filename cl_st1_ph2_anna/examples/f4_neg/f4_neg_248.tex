\begin{textsample}{NEG Dim 4 – al – Score -1.00 – al/al\_ef\_68.txt}  \label{ex:f4_neg_248}
...
Segundo Rigonatto, a modelagem matemática é a criação de um modelo matemático ( um padrão ou \textbf{fórmula} matemática ) para explicação ou compreensão de um fenômeno natural.
...
O estudante passa a perceber a importância da matemática para a compreensão de fenômenos naturais, como é possível “ prever ” alguns acontecimentos utilizando \textbf{fórmulas} e modelos e isso acaba despertando seu interesse pela ciência.
