\begin{textsample}{NEG Dim 4 – ba – Score -2.00 – ba/ba\_inf\_9.txt}  \label{ex:f4_neg_263}
7.9.
...
Nesses termos, o \textbf{portfólio} e o álbum de memória são dispositivos de avaliação de possibilidades valorosas para uma formação qualificada num contexto curricular da Educação Infantil.
...
Exames não têm compromisso com formação qualificada, seu compromisso é com \textbf{verificação} classificatória pura e simples, com fins de hierarquização.
...
% matched lemmas: portfólio, verificação
\end{textsample}
