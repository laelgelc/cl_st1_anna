\begin{textsample}{POS Dim 4 – al – Score 21.00 – al/al\_ef\_101.txt}  \label{ex:f4_pos_005}
5.4.1 Um Olhar para o \textbf{Território} Alagoano O Estado de Alagoas localiza -se na região \textbf{nordeste} de nosso país e possui clima tropical.
...
A caatinga está localizada no oeste do Estado e apresenta uma vegetação de cactos e árvores de pequeno porte, cuja região tem um aspecto seco.
...
Segue lista com exemplos de espécies animais da \textbf{fauna} do estado de Alagoas : Lagarto, Gato-do-mato, Bicho-preguiça, Bem-te-vi, Fura-barreira ( pássaro ), Anu-preto ( pássaro ), Xexéu ( pássaro ), Sagui, Cotia, Quati, Tatu, Teiú, Jiboia, Sabiá-da-mata ( pássaro ), Iguana, Mutum-do-nordeste ou mutum-de-alagoas ( ave-símbolo de Alagoas ).
A \textbf{flora} do estado também bastante diversa, entre elas, espécies vegetais como : Begônia, Umbuzeiro, Braúna, Bromélia, Ipê, Aroeira, Quixabeira, Cedro, Ouricuri, Barbatimão, Mangabeira, Embaúba, Pau-ferro, Ingazeiro.
...
O nome mutum, pelo qual é conhecido, é derivado da palavra da língua tupi \textbf{guarani} “ mitú ”.
...
Não só a ave mutum, mas também algumas espécies vegetais estão ficando cada vez mais raras no estado.
Pouco a pouco elas estão desaparecendo, e por motivos diversos.
Muitas delas, antes comuns em Alagoas, passaram a integrar a categoria das espécies raras no estado, ficando a apenas alguns passos da extinção.
...
Natural da Mata Atlântica, essa árvore tem sumido por conta da ação do homem.
Tal espécie possui características de cicatrização de ferimentos, mas o homem realiza cortes no caule que pode mlevar a morte da espécie.
...
O cedro é outro tipo de árvore rara no estado que não tem sido encontrada sequer no povoado que leva esse nome, situado na cidade de Maravilha, no \textbf{Sertão} alagoano.
...
Uma prática artesanal natural no Litoral Sul do estado, especialmente na cidade de Coruripe, também pode estar ameaçada por conta da ação devastadora do homem.
...
A folha de ouricuri também é utlizada como adornos em rituais religiosos de comunidades indigenas, fato que denota a necessidade da sua preservação e da sua conservação e de todas as espécies do \textbf{território}, contribuindo com as manifestações culturais e a valorização de identidade das comunidades existentes em Alagoas, para os que se utilizam da matéria prima oriunda da \textbf{flora}.
...
% matched lemmas: agreste, artesanato, fauna, flora, floresta, guarani, lagoa, litoral, nordeste, norte, população, rio, sertão, território, índio
\end{textsample}
