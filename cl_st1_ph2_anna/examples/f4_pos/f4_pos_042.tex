\begin{textsample}{POS Dim 4 – al – Score 30.00 – al/al\_inf\_2.txt}  \label{ex:f4_pos_042}
A área territorial de Alagoas é de 27.767,661 km2, compreendido por 102 municípios e conforme IBGE1, a \textbf{população} totaliza 3.322.820 habitantes, com densidade demográfica de aproximadamente 119,31 hab/km2.
...
Localizado na Região \textbf{Nordeste}, o \textbf{Estado} faz limites com Pernambuco, Sergipe, Bahia e o oceano Atlântico.
...
O \textbf{território} é dividido geograficamente em três Mesorregiões : Mesorregiões de Alagoas Mesorregião do \textbf{Agreste} Alagoano Composta pelas Microrregiões de Arapiraca, Palmeira dos \textbf{Índios} e Traipu : Está localizada na área central do \textbf{estado}, está entre o \textbf{Sertão} e a Mata Atlântica.
...
Mesorregião do Leste Alagoano Formada pelas Microrregiões do Litoral Norte Alagoano, Maceió, Mata Alagoana, Penedo, São Miguel dos Campos e Serrana dos \textbf{Quilombo}.
Com 52 municípios, é a Mesorregião mais habitada.
Há um intenso \textbf{turismo} por causa de suas belíssimas \textbf{praias}.
A \textbf{zona} da mata chama atenção, principalmente pela \textbf{flora} e \textbf{fauna} da Mata Atlântica.
Historicamente, a cana de açúcar é a cultura \textbf{predominante}.
...
O povo de Alagoas tem características \textbf{marcantes} : resistência, alegria, resiliência e cordialidade.
...
É crescente o \textbf{turismo} \textbf{ecológico} e de aventura, com descobertas de trilhas, sítios \textbf{arqueológicos} e reservas da mata Atlântica.
O comércio e os serviços têm grandes destaques na economia do \textbf{Estado}.
...
O \textbf{Estado} também possui rebanhos bovinos, equinos, caprinos, bubalinos, piscicultura e ovinos.
...
Mesmo com grande influência \textbf{branco} europeia, destaca -se que os povos tradicionais, \textbf{indígenas} e quilombolas, estão por todo \textbf{Estado} e garantem, principalmente, as \textbf{identidades} culturais do local.

% matched lemmas: agreste, arqueológico, artesanato, branco, coco, ecológico, estado, fauna, flora, folclore, identidade, indígena, lagoa, mar, marcante, nordeste, norte, pardo, população, praia, predominante, quilombo, rio, semiárido, sertão, território, turismo, zona, índio
\end{textsample}
