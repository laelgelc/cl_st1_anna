\begin{textsample}{POS Dim 4 – ap – Score 8.00 – ap/ap\_ef\_20.txt}  \label{ex:f4_pos_238}
Ensino \textbf{Religioso} O ser humano se constrói a partir de um conjunto de relações tecidas em determinado contexto histórico-social, em um movimento ininterrupto de apropriação e produção cultural.
...
% matched lemmas: ancestralidade, floresta, identidade, lócus, mar, religioso, rio, território
\end{textsample}
