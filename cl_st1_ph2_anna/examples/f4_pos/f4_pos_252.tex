\begin{textsample}{POS Dim 4 – df – Score 7.00 – df/df\_inf\_2.txt}  \label{ex:f4_pos_252}
2.
CONTINUANDO NOSSA CONVERSA : a identidade do Distrito Federal expressa no Currículo Linhas modernas.
Desenho futurístico.
...
Além dos povos \textbf{indígenas}, é marcante a presença de comunidade remanescente quilombola, a saber a Comunidade Mesquita, que fica na região do entorno do Distrito Federal.
...
Nessa expansão territorial, criou -se 31 regiões administrativas ( DISTRITO FEDERAL, 2018c ), cada uma com sua identidade, organização e necessidades próprias.
...
% matched lemmas: agrícola, capital, indígena, migração, população, sul, território
\end{textsample}
